...
int convertInteger(int A, int B) 
{
    ...
    return ret;
#endif
    //我们来看上面这个代码，他是一个典型的错误代码，他的结果是死循环，原因是右移操作符分为算数右移运算，算数右移时是用符号位填充的，
    // 而逻辑右移是用0填充的，oj时不断填充1导致死循环，而左移则是统一填0
    //修改时我们要限定位数
    int count = 0;
    int xor= A ^ B;
    for (int i = 0; i <= 31; i++)
...
int test() {
    ...
    //截断后存入 a: 11110110
    char b = 127;
    //原：00000000 000000000 00000000 0111111
    //反：00000000 000000000 00000000 0111111
    //补：00000000 000000000 00000000 0111111
    //截断后存入 b: 01111111
    char c = a + b;
    //先整型提升
    //11111111 11111111 11111111 11110110 + 00000000 000000000 00000000 0111111
    //00000000 00000000 00000001 01110101
    //截断后存入01110101，打印时重新整型提升，输出117
    printf("%d\n", c);
    //————————————————————————————————————————
    char d = 2;
    //原：00000000 00000000 00000000 00000010
    //反：00000000 00000000 00000000 00000010
    //补：00000000 00000000 00000000 00000010
    char e = 126;
    //原：00000000 00000000 00000000 01111110
    //反：00000000 00000000 00000000 01111110
    //补：00000000 00000000 00000000 01111110
    char f = d + e;
    //先整型提升
    //00000000 00000000 00000000 00000010 + 00000000 00000000 00000000 01111110
    //00000000 00000000 00000000 10000000
    //截断后存入10000000，打印时重新整型提升，变成
